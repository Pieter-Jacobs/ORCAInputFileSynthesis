...
class CCFrequencyCalculation:
    ...
    def process_keywords(self):
        ...
        if self.freq_gradient == 'numfreq': self.base_class.keywords.append("engrad")
...
class DFTFrequencyCalculation:
    ...
    def choose_ri_approximation(self):
        ...
        if self.base_class.functional_type == 'non-hybrid':
            ri_approximation = "ri"
        elif self.base_class.functional_is_range_seperated():  # geom needs rijcosx for range seperated
